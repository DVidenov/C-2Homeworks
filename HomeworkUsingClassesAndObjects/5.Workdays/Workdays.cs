...
//Kodut ne e izcqlo moi vzeh ideqta ot kolegi vuv foruma, zashtoto ne uspqh da se spravq sam**********
class Workdays
{
    ...
    static void Main()
    {
        ...
        Console.WriteLine("Workdays there between {0:dd.MM.yyyy} and {1:dd.MM.yyyy} are", dateNow, futureDate);
        Console.WriteLine("\nWorkdays: {0}", CheckWorkingDays(dateNow, futureDate));
    }
